...
export default function ProductCard({ product }) {
  return (
    <Link
      ...
      className="w-[250px] m-4 h-[360px] rounded-2xl shadow-lg overflow-hidden bg-white
                 transition-transform transform hover:scale-105 hover:shadow-[0_10px_20px_rgba(220,20,60,0.4)]"
    >
      ...
      <div className="h-[140px] p-4 flex flex-col justify-between">
        ...
        <p className="text-lg font-semibold text-black truncate">{product.name}</p>
