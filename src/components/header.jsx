  ...
  return (
    <header className="h-[70px] w-full flex justify-start items-center bg-gradient-to-r from-[#FDEFF4] via-[#FFC0D3] to-[#FF5C8D] relative shadow-md">
      ...
      <div className="hidden lg:flex w-[500px] h-full items-center justify-evenly text-[#524A4E] text-xl font-semibold">
        ...
        <Link to="/products" className="hover:text-[#FF5C8D] transition-colors">Products</Link>
        <Link to="/contact" className="hover:text-[#FF5C8D] transition-colors">Contact us</Link>
        <Link to="/reviews" className="hover:text-[#FF5C8D] transition-colors">Reviews</Link>

        <div className="absolute right-[70px] h-full">
          <UserData />
        </div>

        <Link to="/cart" className="absolute right-[40px] text-2xl text-[#524A4E] hover:text-[#FDEFF4] transition-colors">
          <BsCart4 />
        </Link>
      </div>
      ...
      {isOpen && (
        <div className="fixed lg:hidden z-[9999] top-0 left-0 w-full h-screen bg-[#524A4E80] flex">
          <div className="w-[300px] h-full bg-[#FDEFF4] flex flex-col justify-start items-start p-4 shadow-lg relative">
            ...
            <Link to="/" className="text-xl text-[#524A4E] my-4 hover:text-[#FF5C8D] transition-colors" onClick={() => setIsOpen(false)}>Home</Link>
            <Link to="/products" className="text-xl text-[#524A4E] my-4 hover:text-[#FF5C8D] transition-colors" onClick={() => setIsOpen(false)}>Products</Link>
