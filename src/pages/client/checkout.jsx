...
export default function CheckoutPage() {
  ...
  function getTotalForLabelledPrice() {
    return cart.reduce(
      (acc, item) => acc + item.labeledPrice * item.quantity,
      0
    );
  }
    ...
    <div className="w-full min-h-screen flex justify-center p-[40px] bg-[#FDEFF4]">
      <div className="w-[700px]">
        {cart.map((item, index) => (
          <div
            key={index}
            className="w-full h-[100px] bg-white shadow-[0_6px_15px_rgba(82,74,78,0.1)] my-3 flex justify-between items-center relative rounded-xl transition hover:shadow-[0_10px_20px_rgba(82,74,78,0.2)]"
          >
            <button
            ...
            <div className="h-full max-w-[300px] w-[300px] overflow-hidden px-2">
              ...
              <h2 className="text-lg text-[#524A4E]">
                {item.altNames.join(" | ")}
              </h2>
              <h2 className="text-lg text-[#524A4E]">
            ...
            <div className="h-full w-[100px] flex justify-center items-center">
              <h1 className="text-xl w-full text-end pr-2 text-[#524A4E]">
        ...
        <div className="w-full flex justify-end mt-4 gap-4">
          <div className="flex justify-between w-[220px]">
            ...
            <h1 className="text-xl text-[#524A4E]">
        ...
        <div className="w-full flex flex-col gap-3 mt-4">
          <input
            placeholder="Name"
            className="w-full text-xl border-b-[2px] border-[#FF5C8D] px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#FFC0D3]"
            value={name}
