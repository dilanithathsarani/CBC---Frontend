    ...
    <div className="w-full min-h-screen flex justify-center p-[40px] bg-[#FDEFF4]">
      <div className="w-full lg:w-[700px]">
        {cart.map((item, index) => (
          <div
            key={index}
            className="w-full lg:h-[100px] bg-white shadow-[0_6px_15px_rgba(82,74,78,0.1)] my-3 flex lg:flex-row flex-col justify-between items-center relative rounded-xl transition hover:shadow-[0_10px_20px_rgba(82,74,78,0.2)]"
          >
            <button
            ...
            <img
              src={item.image}
              className="h-[100px] lg:h-full aspect-square object-cover rounded-l-xl"
            />
