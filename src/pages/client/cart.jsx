            ...
            <div className="w-full lg:w-[700px]">
                {
                    cart.map((item , index)=>{
                        return(
                            <div key={index} className="w-full lg:h-[100px] bg-white shadow-2xl my-[5px] flex lg:flex-row flex-col justify-between items-center relative rounded-xl">
                                <button className="absolute right-4 lg:right-[-50px] bg-[#DC143C] w-[40px] h-[40px] rounded-full text-white flex justify-center items-center shadow cursor-pointer hover:bg-[#F75270]" 
                                onClick={()=>{
                                ...
                                <div className="h-full w-[100px] flex justify-center items-center">
                                    <button className="text-2xl w-[30px] h-[30px] bg-[#F75270] text-white rounded-full flex justify-center items-center cursor-pointer mx-[5px] hover:bg-[#DC143C]"
                                    onClick={()=>{
                                        addToCart(item,-1)
                                        setCartLoaded(false)
                                    }}>-</button>
                ...
                <div className="w-full flex justify-end mt-4">
                    <button className="w-[170px] text-xl text-center shadow pr-2 bg-[#FF8BA0] text-white h-[40px] rounded-lg cursor-pointer hover:bg-[#DC143C] transition-all duration-300" 
                    onClick={()=>{
                        navigate("/checkout",
                            {
                                state : {
