...
export default function ProductsPage() {
    ...
    return (
        <div className="min-h-screen w-full bg-[#FDEBD0] py-10 px-4">
            <div className="w-full max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
                <div className="relative w-full sm:w-[300px]">
                    ...
                    {search && (
                        <AiOutlineClose
                            onClick={() => setSearch("")}
                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#E41F7B] cursor-pointer hover:text-[#DC143C]"
                            size={18}
                        />
                    )}
                </div>
                ...
                <button
                    className="bg-[#DC143C] text-white font-medium px-4 py-2 rounded-md border-2 border-[#DC143C] hover:bg-[#F75270] hover:border-[#F75270] hover:text-white transition-all duration-300"
                ...
                <button
                    className="bg-[#F75270] text-white font-medium px-4 py-2 rounded-md border-2 border-[#F75270] hover:bg-[#FDEBD0] hover:text-[#DC143C] hover:border-[#DC143C] transition-all duration-300"
